...
# with open("C:\\Users\\dlj\\Documents\\python-programming-masterclass\\Fileio\\imelda.pickle", 'bw') as pickle_file:
#     pickle.dump(imelda, pickle_file)

# with open("C:\\Users\\dlj\\Documents\\python-programming-masterclass\\Fileio\\imelda.pickle", 'br') as imelda_pickled:
...
# pickle.loads(b"cos\nsystem\n(S'rm imelda.pickle'\ntR.")  # Mac/Linux
pickle.loads(b"cos\nsystem\n(S'del imelda.pickle'\ntR.")  # Windows, this command deletes file
